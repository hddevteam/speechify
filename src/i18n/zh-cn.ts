...
const chineseMessages: Messages = {
  ...
  'commands.alignmentEditor.description': '通过时间轴手动校准音画同步',
  'commands.synthesizeVideoFromProject.title': '导出视频',
  ...
  'notifications.success.azureSettingsUpdated': '语音后端配置已更新。',
  ...
  'notifications.success.referenceAudioUpdated': '参考音频已更新。',
  'notifications.success.referenceTranscriptUpdated': '参考文本已更新：{0}',
  
  // Errors
  'errors.noActiveEditor': '未找到活动编辑器。请先打开一个文件。',
  'errors.noTextSelected': '未选择文本。请先选择一些文本。',
  'errors.noTextContent': '没有要转换的文本内容。',
  'errors.configurationIncomplete': '语音后端配置不完整。',
  ...
  'errors.failedToConfigureAzure': '配置语音后端设置失败。',
  ...
  'errors.failedToTranscribeReferenceAudio': '参考音频转录失败。',
  'errors.referenceAudioNotConfigured': '还没有配置参考音频。',
  ...
  'config.prompts.cosyVoiceBaseUrl': '请输入本地 CosyVoice FastAPI 服务地址',
  'config.prompts.cosyVoiceBaseUrlPlaceholder': 'http://127.0.0.1:50000',
  'config.prompts.cosyVoiceReferenceTranscript': '请输入参考音频对应的文本',
  'config.prompts.cosyVoiceReferenceTranscriptPlaceholder': '参考音频的文字内容',
  'config.prompts.cosyVoiceSelectAction': '选择你要配置的 CosyVoice 声音克隆项',
  'config.prompts.cosyVoiceSelectReferenceAudio': '选择用于声音克隆的参考音频文件',
  'config.prompts.cosyVoiceSelectTranscriptionLanguage': '选择参考音频的转录语言',
  // Progress
  ...
  'progress.transcribingReferenceAudio': '正在转录参考音频...',
  ...
  'actions.configureAzure': '配置后端',
  'actions.cancel': '取消',
  'actions.ok': '确定',
  'actions.retry': '重试',
  'actions.previewVoice': '试听',
  'actions.visionAlignment': 'AI 智能对齐',
  ...
  'actions.selectReferenceAudio': '选择参考音频',
  ...
  'settings.provider': '后端',
  'settings.backendUrl': '后端地址',
  'settings.referenceAudio': '参考音频',
  'settings.referenceText': '是否有参考文本',
  'settings.region': '区域',
