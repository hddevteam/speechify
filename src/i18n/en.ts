...
const englishMessages: Messages = {
  ...
  'commands.alignmentEditor.description': 'Manually calibrate audio-visual sync via timeline editor',
  'commands.synthesizeVideoFromProject.title': 'Export Video',
  ...
  'notifications.success.azureSettingsUpdated': 'Speech backend configuration updated.',
  ...
  'notifications.success.referenceAudioUpdated': 'Reference audio updated.',
  'notifications.success.referenceTranscriptUpdated': 'Reference transcript updated: {0}',
  ...
  'errors.configurationIncomplete': 'Speech backend configuration is incomplete.',
  ...
  'errors.failedToConfigureAzure': 'Failed to configure speech backend settings.',
  ...
  'errors.failedToTranscribeReferenceAudio': 'Failed to transcribe reference audio.',
  'errors.referenceAudioNotConfigured': 'Reference audio is not configured yet.',
  ...
  'config.prompts.cosyVoiceBaseUrl': 'Enter your local CosyVoice FastAPI base URL',
  'config.prompts.cosyVoiceBaseUrlPlaceholder': 'http://127.0.0.1:50000',
  'config.prompts.cosyVoiceReferenceTranscript': 'Enter the transcript for the reference audio',
  'config.prompts.cosyVoiceReferenceTranscriptPlaceholder': 'Transcript of the reference audio',
  'config.prompts.cosyVoiceSelectAction': 'Choose what to configure for your CosyVoice reference voice',
  'config.prompts.cosyVoiceSelectReferenceAudio': 'Select the reference audio file used for voice cloning',
  'config.prompts.cosyVoiceSelectTranscriptionLanguage': 'Choose the transcription language for the reference audio',
  ...
  'progress.transcribingReferenceAudio': 'Transcribing reference audio...',
  ...
  'actions.configureAzure': 'Configure Backend',
  'actions.cancel': 'Cancel',
  'actions.ok': 'OK',
  'actions.retry': 'Retry',  'actions.previewVoice': 'Preview',  'actions.visionAlignment': 'AI Smart Align',
  ...
  'actions.selectReferenceAudio': 'Select Reference Audio',
  ...
  'settings.referenceAudio': 'Reference Audio',
  'settings.referenceText': 'Has Reference Text',
